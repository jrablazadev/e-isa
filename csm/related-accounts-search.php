...
<body class="hide">
    ...
    <div id="cb-deal-directory">
        <script type="text/javascript" src="<?= $cb_datapage_prefix ?>6692510839ef4e1e90cc/emb"></script>
    </div>
    ...
    <script>
        document.addEventListener('DataPageReady', function(event) {
            if (event.detail.appKey.includes('6692510839ef4e1e90cc')) {
