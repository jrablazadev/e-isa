...
<body class="hide">
	...
	<main role="main" class="container">
		...
		<div id="scratch-pad-container" class="cb-report mb-3">
			<script type="text/javascript" src="<?= $cb_datapage_prefix ?>8ee50769a0604cedb505/emb"></script>
		</div>
		...
		<div>
			...
			<div class="overflow-auto cb-report mb-3 cb-approved">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>1185f2ac033f4e328f6d/emb"></script>
			</div>

			<div class="table-header mb-2"><strong>ISAs in Deal Sheet Phase</strong></div>
			<div class="overflow-auto cb-report mb-3">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>9a536459cb524a21a164/emb"></script>
			</div>

			<!-- Step 3 -->
			<div class="table-header mb-2"><strong>ISAs in Contract Phase</strong></div>
			<div class="overflow-auto cb-report mb-3">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>0a2f719017544bc4b36c/emb"></script>
			</div>
