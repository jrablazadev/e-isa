	...
	<main role="main" class="container">
		...
		<div>
			...
			<div class="overflow-auto cb-report mb-3 cb-approved">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>cc0ebfcbff93426db2c9/emb"></script>
			</div>

			<div class="table-header mb-2"><strong>ISAs in Deal Sheet Phase</strong></div>
			<div class="overflow-auto cb-report mb-3">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>55e35cc444a348baba82/emb"></script>
			</div>

			<!-- Step 3 -->
			<div class="table-header mb-2"><strong>ISAs in Contract Phase</strong></div>
			<div class="overflow-auto cb-report mb-3">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>9d2438a5972948a4ad9c/emb"></script>
			</div>
			...
			<div class="overflow-auto cb-report mb-3 cb-execution-work">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>b035a5e1c880477082ef/emb"></script>
			</div>
			...
			<div class="cb-report mb-3">
				...
				<div class="overflow-auto" id="cb-team-breach">
					<script type="text/javascript" src="<?= $cb_datapage_prefix ?>004eeaea2c7745e5ae04/emb"></script>
				</div>
			</div>
