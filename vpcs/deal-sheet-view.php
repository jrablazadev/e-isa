...
<head>
	...
	<title>E-ISA | Deal Sheet - View</title>
...
<body class="hide">
	...
	<main role="main" class="container mb-5 mt-5">
		<div class="mb-5">
			<script type="text/javascript" src="<?= $cb_datapage_prefix ?>7fe4de1a9bbf4d149541/emb"></script>
		</div>
		...
		<div id="section10-1" class="mb-5">
			...
			<div>
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>e4fcb3f152604d75867a/emb"></script>
			</div>
		</div>
		...
		<div id="section10-2" class="expandheader mb-5">
			...
			<script type="text/javascript" src="<?= $cb_datapage_prefix ?>339889e04ed44535abff/emb"></script>
		</div>
