    ...
    <main role="main" class="container">
        ...
        <div>
            ...
            <div class="overflow-auto cb-report mb-3 cb-approved">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>976d73e526d3456baef1/emb"></script>
            </div>

            <div class="table-header mb-2"><strong>ISAs in Deal Sheet Phase</strong></div>
            <div class="overflow-auto cb-report mb-3">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>ef4f72f459204f69a3cd/emb"></script>
            </div>

            <!-- Step 3 -->
            <div class="table-header mb-2"><strong>ISAs in Contract Phase</strong></div>
            <div class="overflow-auto cb-report mb-3">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>f0fdabaca1fb40dbb4e3/emb"></script>
            </div>
            ...
            <div class="overflow-auto cb-report mb-3 cb-execution-work">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>776c517679d747fdbc51/emb"></script>
            </div>
            ...
            <div class="cb-report mb-3">
                ...
                <div class="overflow-auto" id="cb-team-breach">
                    <script type="text/javascript" src="<?= $cb_datapage_prefix ?>c0cd16c2b63a4409bfc4/emb"></script>
                </div>
            </div>
