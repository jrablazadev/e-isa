...
<body class="hide">
    ...
    <main role="main" class="mb-5 ml-5 mr-5">
        <div class="cb-header font-weight-bold bg-dark text-white mb-3"><b>Manufacturer Color Subscription Hub</b></div>
        <div class="cb-report" id="cb-manufacturer-color-subscription-hub">
            <script type="text/javascript" src="<?= $cb_datapage_prefix ?>b96a9d3e109a412da10b/emb"></script>
        </div>
