...
<html lang="en">
	...
	<body class="hide">
		...
		<main class="mb-5 ml-5 mr-5">
			...
			<div class="cb-search">
				<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d55000ed645c249cf748e5b2ba/emb"></script>
			</div>
			...
			<div class="cb-report mb-3" id="cb-deal-directory">
				...
				<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d550004a8f0b79a16c4b589987/emb"></script>
			</div>
		</main>
		...
		<script>
			...
			<?php echo file_get_contents('../js/deal-directory-sm.js'); ?>
		</script>
	</body>
</html>