	...
	<body class="hide">
		...
		<main role="main" class="container">
			...
			<div class="d-none">
				...
				<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d5500054df91e58b964ecb86f5/emb"></script> <!-- Accounts Related - GLID -->
			</div>
			...
			<div class="mb-3 manufacturer-rebates">
				...
				<div id="manufacturer-rebates-embed" class="d-none">
					<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d550000439bae402fd4caa97d6v/emb"></script> <!-- Manufacturer Rebates-->
				</div>
			</div>
			...
			<div class="mb-3">
				<h4 class="step-6-container">
					...
					<a href="./direction-to-pay-3.php?ISA_ID=<?php echo isset($_GET['ISA_ID']) ? $_GET['ISA_ID'] : 0; ?>&Section_ID=12" class="d2p-anchor">Here</a>
				</h4>
			</div>

			<div class="mb-3">
				<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d550002d6024534633473785d1/emb"></script> <!-- Hot Buttons -->
			</div>
			...
			<div class="mb-3">
				<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d55000f80be512f9f14c39ba69/emb"></script> <!-- COMMENTS SECTION -->
			</div>
		</main>

		<script>
			<?php echo file_get_contents('../js/allied-set-up.js'); ?>
		</script>
	</body>
</html>
