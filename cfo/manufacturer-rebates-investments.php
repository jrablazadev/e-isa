...
<html lang="en">
	...
	<body class="hide">
		...
		<main role="main" class="container">
			...
			<div class="d-none">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>288517adb7084773b2e2/emb"></script> <!-- Validation: Active Section -->
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>b8fc270763644165bbcd/emb"></script> <!-- Validation: Invoice Discount.Percentage of Business = 100% -->
			</div>

			<?php include_once "../partials/progressbar.php"; ?>

			<div class="cb-mfr-rebates section-container container1 grid-edit">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>42421c167a5944c7b0b2/emb"></script> <!-- Manufacture Rebates -->
			</div>
			...
			<div class="d-none">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>5d18061661ca4d5fbb69/emb"></script> <!-- HIDDEN: Change Manufacture Submit for Re-approval -->
			</div>

			<div class="d-none" id="entryraw-container"></div>

			<div class="mb-3 calc-summary-container">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>e6fa8ea67191406f98e4/emb"></script> <!-- Quick Analysis -->
			</div>

			<div class="mb-3">
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>f80be512f9f14c39ba69/emb"></script> <!-- Comments -->
			</div>
		</main>
