...
<html lang="en">
	...
	<body class="hide">
		...
		<main role="main" class="container">
			...
			<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d550005a1f6380977a4144b939/emb"></script>
		</main>
		...
		<script>
			...
			$(document).on('click', '.cb-rl-eisa-id', function(){
				if(confirm('Are sure you want to select this E-ISA ID?'))
				{
					$('*[name$="RecordCurrent_EISA_No"]').val(this.value);
