<nav class="navbar navbar-expand-lg navbar-dark primary-nav bg-dark w-100" style="display: inline-table !important">
    ...
    <div class="container-fluid">
        ...
        <a class="pointer-event-none small cb-text-grey text-right" href="#">TSM</a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown" id="nav-reports">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="<?= $cb_datapage_prefix ?>eb3c8082efe140fc8e6a" target="_blank">Current Month Rebate Detail</a>
                ...
                <li class="nav-item" id="nav-dashboard">
                    <a class="nav-link" href="./dashboard.php?cbResetParam=1">
