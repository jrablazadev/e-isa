...
<html lang="en">
	...
	<body class="hide">
		...
		<main role="main" class="container">
			...
			<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d550005a1f6380977a4144b939/emb?Last_Approver_ID=1"></script>
		</main>
		...
		<script>
			<?php echo file_get_contents('../js/hide-acq-tsm.js'); ?>
