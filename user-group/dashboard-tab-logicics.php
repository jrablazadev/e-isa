...
<body class="hide">
        ...
        <script>
                deployDP('cb-logicics-exec-work-queue', `${globalDataPagePrefix}1ded9b7819d34c5894a5/emb`);
                deployDP('cb-logicics-breach', `${globalDataPagePrefix}54dd726bcf644b4bb4fb/emb`);
        </script>
