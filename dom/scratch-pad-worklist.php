...
<body class="hide">
    ...
    <main role="main" class="container">
        ...
        <div id="scratch-pad-container">
            ...
            <div id="scratch-pad-container" class="cb-report">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>9ec3bc79af5a46b59b62/emb"></script>
            </div>

            <div class="headers bg-dark mb-2">STEP 2 APPROVALS</div>
            <div class="table-header mb-2"><strong>My Approval Needed</strong></div>
            <div class="cb-report mb-3 cb-myapproval overflow-auto">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>0d9969d702e049d8bd77/emb"></script>
            </div>

            <div class="table-header mb-2"><strong>Upcoming Approvals</strong></div>
            <div class="cb-report mb-3 cb-upcoming overflow-auto">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>c93f972dd87b402aae12/emb"></script>
            </div>

            <div class="table-header mb-2"><strong>Approved ISAs List</strong></div>
            <div class="cb-report mb-3 cb-approved overflow-auto">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>71f7a7c3a0b3458f8ac8/emb"></script>
            </div>
            ...
            <div class="cb-report mb-3 cb-dealsheet overflow-auto">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>4618793597d64d6b9094/emb"></script>
            </div>
            ...
            <div class="cb-report mb-3 cb-contractphase overflow-auto">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>1436b15bf0bb42a28222/emb"></script>
            </div>
            ...
            <div class="cb-report mb-3 cb-execution-phase overflow-auto">
                <script type="text/javascript" src="<?= $cb_datapage_prefix ?>327796dcd81547789f6c/emb"></script>
            </div>
            ...
            <div class="cb-report mb-3">
                ...
                <div class="overflow-auto" id="cb-team-breach">
                    <script type="text/javascript" src="<?= $cb_datapage_prefix ?>f91c845405554b4f85f7/emb"></script>
                </div>
            </div>
            ...
            <div class="cb-report mb-3">
                ...
                <div class="overflow-auto" id="cb-doc-exep-report">
                    <script type="text/javascript" src="<?= $cb_datapage_prefix ?>44579d67bb704b1eadb6/emb"></script>
                </div>
            </div>
    ...
    <style>
        ...
        .cb-myapproval tr[data-cb-name="data"]>*:nth-child(3),
