...
document.addEventListener("DataPageReady", function(event) {
    if (event.detail.appKey.includes("ef76b73d6082474aadbe") || event.detail.appKey.includes("d8053e16d8d14ecf8c21")) {
        makeDashboardMetricForISATeamGroup(".dashboard-metrics-pricing", bucketApp_Keys_Pricing, bucketLabels, 'pricing')
    }
    ...
    // }
    if (event.detail.appKey.includes("3d55741dfcb44c6aa8f1") || event.detail.appKey.includes("7446581508a7475095a0")) {
        makeDashboardMetricForISATeamGroup(".dashboard-metrics-finance", bucketApp_Keys_Finance, bucketLabels, 'finance')
    }
    ...
    //     makeDashboardMetricForISATeamGroup(".dashboard-metrics-credit", bucketApp_Keys_Credit, bucketLabels_Credit, 'credit')
    // }
    if (event.detail.appKey.includes("5e3efbb2501443789cf6") || event.detail.appKey.includes("5a6aa2aa2e734b97aca6") || event.detail.appKey.includes("62ebac071ec04163bf0a") || event.detail.appKey.includes("4715d70e3b0049f9977e")) {
        makeDashboardMetricForISATeamGroup(".dashboard-metrics-clevel", bucketApp_Keys_CLevel, bucketLabels_CLevel, 'c-level')
    }
