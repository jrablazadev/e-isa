...
{
	// console.log('customer-sales-no-growth.js');
...
{
	$('form[action*="d424fe7ab6ae4af9896a"] table[data-cb-name="cbTable"] input[type="checkbox"][data-selected="N"]').prop('checked', elem.checked);
...
document.addEventListener('DataPageReady', function (event) {
	...
	if(event.detail.appKey.includes("c00e9414db644c4fbb7f")) // section 2 submission form
	{
	...
	if(event.detail.appKey.includes("d424fe7ab6ae4af9896a")) // add related accounts
	{
