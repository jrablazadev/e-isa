...
document.addEventListener('DataPageReady', function (event) {
	if(event.detail.appKey == '25d55000eceb3babc05f41dcad98')
	{
...
function moveCogAndCustomerName()
{
	$('.cb-deal-amortization tr[data-cb-name="group2"]').each(function(){
		...
		$(this).find('*[data-cb-name="groupLabelCell2"]').prepend(cogBtn);
		$(this).find('*[data-cb-name="groupLabelCell2"]').append(' | \
			<span class="cb-customer-name"> \
			E-ISA ' + isaId + ' \
			<span class="cb-legal-name" data-value="' + legalName + '">, ' + legalName + ' </span> \
			<span class="cb-city" data-value="' + city + '">, ' + city + ' </span> \
			<span class="cb-state" data-value="' + state + '">, ' + state + ' </span> \
			</span> \
		');
	});
...
function showTotalAmortized()
{
	...
	$('.cb-deal-amortization tr[data-cb-name="group2"]').each(function(){
		...
		var totalAmortizedByIsa = amortizedElem.attr('data-sum-by-isa-id');
	...
	$('.cb-deal-amortization tr[data-cb-name="group1"]').each(function(){
		...
		var amortizedElem = nextRow.find('.cb-total-amortized');
		var totalAmortizedByGlid = amortizedElem.attr('data-sum-by-glid');
