...
function reset_breach_search(appkey) {
	...
	const [termination_step_field, termination_step_virtual_field] =
		breach_dps_fields[appkey_withoutprefix].termination_step || [];
	...
	form.find(`*[name="${termination_step_virtual_field}"]`).val(
		"|1| OR |2| OR |3| OR |4| OR |5| OR |6| OR |7|".split(" OR ")
	);
