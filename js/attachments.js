...
$(document).on('change', '*[name="EditRecordMFG_Contract_Pro_Attachment"]', function(event){
        console.log($('*[name="EditRecordMFG_Contract_Pro_Attachment"]').val());
...
document.addEventListener('DataPageReady', function (event) {
	...
	// console.log( (event.detail.appKey).toUpperCase() == ('25d55000edd4c28ef31e44839963').toUpperCase() );
        ...
        if((event.detail.appKey).toUpperCase() == ('25d55000edd4c28ef31e44839963').toUpperCase())
        {
		...
		$('form[action*="edd4c28ef31e44839963"] input[name="cbParamVirtual5"]').change(function(){
        ...
        add_related_account_pop_up = $.confirm({
                    ...
                    , buttons:
                    {
                            buttonYes :
                            {
                                        ...
                                        , action: function (){
                                                window.location.href = "./customer-sales-no-growth.php?ISA_ID="+urlParams.get('ISA_ID')+"&Section_ID=2"
                                        }
                            }
                    }
            });
...
$(document).on('click', '.nextbtn', function(e){
        ...
        if(changedMfgContract && $('*[name="EditRecordMFG_Contract_Pro_Attachment"]').val() == ""){
