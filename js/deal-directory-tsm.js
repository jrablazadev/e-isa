...
function percent_complete_graph() {
	$(
		'#sprint1-new-deal-result *[data-cb-name="data"] td:nth-child(11)'
	).each(function () {
...
function deal_tracking_score() {
	$(
		'#sprint1-new-deal-result *[data-cb-name="data"] td:nth-child(12)'
	).each(function () {
		var rawNumber = $(this).html() || "";
		if (rawNumber === "&nbsp;") {
			rawNumber = "0.0";
...
function sales_trend_icon() {
	$(
		'#sprint1-new-deal-result *[data-cb-name="data"] td:nth-child(13)'
	).each(function () {
...
function sales_trend_icon_related_account() {
	$('#tsm-account-related *[data-cb-name="data"] td:nth-child(11)').each(
		function () {
			if ($(this).attr("data-has-icon") == "Y") {
				return true;
			}
