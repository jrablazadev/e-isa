...
var cogLinks = {
  ...
  , 'b6d70f7d2e2a434eb356': ['Log AMP - ISA ID', 'Comments', 'Attachments - Filtered', 'Related Accounts - View TSM', 'Create New Deal - TSM', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line - TSM', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  ...
  , '69b133f4c3f548deae74': ['Log AMP - ISA ID', 'Comments', 'Attachments - Filtered', 'Related Accounts - View TSM', 'Create New Deal', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line - TSM', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory

  // Shared - ISM, TSM
  , 'd2544125952c4fcd8105': ['Log AMP - ISA ID', 'Comments', 'Attachments - Filtered', 'Related Accounts - View TSM', 'Create New Deal', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line - TSM', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  , 'f2efc3c1a962429a987d': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Related Account Search
  ...
  , '1b3d5617e58449fca041': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2 - CSM
  ...
  , 'f0197819e0bb48ac81f8': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  , '2381f2265d35423f8a95': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  ...
  , 'f0197819e0bb48ac81f8': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  , '037cd8daa4744c1095bf': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  ...
  , 'f6ed409a607c417ca803': ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] //  Deal Directory
  ...
  , '6663b65b7c1d4a16b0cd': ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] //  Deal Directory
  ...
  , 'f62ddfe088ee4839905b': ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] //  Deal Directory
  ...
  , 'd4066d2600604fb4b044': ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] //  Deal Directory
  ...
  , '9b2b60bac6e546a88e3e': ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] //  Deal Directory
  ...
  , '498c7df29bdc4cc492ef': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  , '99ba6cb5d82245a5b628': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  , 'f82f8b88518a443d8cea': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Related Account Search
  , 'a8b40053c0884c1eb336': ['View Details', 'Attachments', 'Comments', 'E-ISA Logs', 'Sales by Product Line'] // Historical Deal Directory
  ...
  , 'bac4985cc0ac485797ae': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  , 'cc670d6248c74a58b3f7': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  , '7ba75dbee7514783bf66': ['View Details', 'Attachments', 'Comments', 'E-ISA Logs', 'Sales by Product Line'] // Historical Deal Directory
  ...
  , '136439fb7aec407cbed5': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  , 'fbd0edcb06834f76b169': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  , 'b4bf730cf8f74ae48005': ['View Details', 'Attachments', 'Comments', 'E-ISA Logs', 'Sales by Product Line'] // Historical Deal Directory
  ...
  , '63f217cac0c847ad8a1b': ['View Details', 'Edit Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summarys'] // Deal Directory
  , '7229fa8e5f50432da038': ['View Details', 'Edit Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  ...
  , '1fe1ec21b4a5407f9a47': ['View Details', 'Attachments', 'Comments', 'Related Accounts - View', 'E-ISA Logs', 'Sales by Product Line'] // Historical Deal Directory
  ...
  , 'de68c8357bc94d299955': ['View Details', 'Edit Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Related Accounts Tabular Modal
  , 'b0395fb832204330bd4e': ['View Details', 'Edit Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Related Accounts Tabular Modal
  ...
  , '4a8f0b79a16c4b589987': ['Log AMP - ISA ID', 'Comments', 'Attachments - Filtered', 'Related Accounts - View - Approvers', 'Create New Deal', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line - TSM', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  , 'df460ba8283b41008c99': ['View Details', 'Attachments', 'Comments', 'E-ISA Logs', 'Sales by Product Line'] // Historical Deal Directory
  ...
  , '25262312258a45e3ae1e': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  , 'addcd06cf8594dfba8b4': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  , 'c5134e9e869d4425a967': ['View Details', 'Attachments', 'Comments', 'E-ISA Logs', 'Sales by Product Line'] // Historical Deal Directory
  ...
  , '3cba56b852da4645ac6b': ['View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  , '8604295b600d4e91baa4': ['View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  ...
  // Logic Team
  , '0faff3f982f24ec8a871': ['Log AMP - ISA ID', 'Attachments', 'Related Accounts - View - Approvers', 'ComCept AR', 'ComCept Pricing', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2


  // CFO COO CEO
  , '2282c5791cb246e6b593': ['View Details', 'Attachments', 'Comments', 'E-ISA Logs', 'Sales by Product Line'] // Historical Deal Directory
  ...
  , 'da025f6ccee643b7821a': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  , '47bbef748cce468fb668': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2
  , '7fb89b3497914e4c9e47': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory 2 - CEO, CFO, COO, KN
  , '6692510839ef4e1e90cc':['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Related Accounts Search
  ...
  , 'cf23ebc6ba694402b926':['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Rebate Details', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Related Accounts Search All E-ISA


  // Users
  , '9813a8444b764f8590ac': ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
  ...
  , '1c72a60eee144283bcb2': ['View Details', 'Edit Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Product Line', 'Manufacturer Subscription Fee Summary', 'Log1c Subscription Fee Summary'] // Deal Directory
...
/*
  ...
  // , '9b4423d2683543168fc8' : ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] // Deal Directory
  // , '9b4423d2683543168fc8' : ['Log AMP - ISA ID', 'Comments', 'Attachments - Filtered', 'Related Accounts - View TSM', 'Create New Deal', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] // Deal Directory
  ...
  // , 'fe0e6382d2444a2bacd2' : ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] // Deal Directory
  // , 'fe0e6382d2444a2bacd2' : ['Log AMP - ISA ID', 'Comments', 'Attachments - Filtered', 'Related Accounts - View', 'Create New Deal', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] // Deal Directory
  ...
  // , '2c7a58724a774de38563' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory

  RSM
  // , '7de177a7731b450bbd2e' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory
  ...
  , 'fc10589851974509a116' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory

  Accounting
  // , 'e38a97f2264947ff9437' : ['View Details', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View'] //  Approved
  // , '6a69946586474e9b81f5' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory

  DSM
  // , 'fc59a60ab6b84edd9ae5' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Create New Deal', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory

  RVPS
  // , '6d2a88fd38854a2a94fd' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Create New Deal', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory
  RVPO
  // , '880bbe8872954a8aa533' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Create New Deal', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory

  ISA Team
  // , '5eeb15dbeb1a425c908a' : ['View Details', 'Edit Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Product Line'] //  Deal Directory

  Tom B.
  // , '060418d036fb4620b99d' : ['View Details', 'Comments', 'Attachments', 'Related Accounts', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory

  CFO
  // , '4b797fb9e94c4e63a277' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'Allocate Asset - View', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line', 'Contract Summary Exhibit C'] //  Deal Directory

  COO
  // , '4fb97b82947d43e9a1df' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory


  CEO
  // , '63e4ecc84bdc45c8ae24' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory

  SM
  // , 'babdfe7b901543cd97a7' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory
  // , 'ba77fd397d0447618aa9' : ['Log AMP - ISA ID', 'View Details', 'Comments', 'Attachments', 'Related Accounts - View - Approvers', 'Allocate Asset - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] // Deal Directory
  // , 'ba77fd397d0447618aa9' : ['Log AMP - ISA ID', 'Comments', 'Attachments - Filtered', 'Related Accounts - View - Approvers', 'Create New Deal', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line - TSM'] // Deal Directory

  DOM
  // , '83cd1d9bc2a84bfdbdce' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] //  Deal Directory
  ...
  Users
  // , '9efc26337fa547d680f5' : ['View Details', 'View Attachments', 'E-ISA Logs', 'Create New Deal', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Product Line'] // DD
*/
...
// Sales by Product Line - Corp 1 and 2
...
function create_cog(elem) {
  ...
  const subfolder = window.parent.location.pathname.split('/').at(-2).toLowerCase();
  const arr_removed_renewDeal = ['so', 'ar','srf','ap', 'accounting', 'marketing', 'si', 'cfo', 'ceo', 'coo'];
  var cogHTML = ''
  ...
  //removing renew deal from specific role
  if(arr_removed_renewDeal.includes(subfolder)){
    cogLinks[appKey] = cogLinks[appKey].filter(item => item !== "Create New Deal");
  }
  ...
  $.each(cogLinks[appKey], function (i, link) {
    switch (link) {
      ...
      case 'Sales by Product Line - TSM':
        cogHTML += '<a href="#' + isaId + '" class="dropdown-item cb-sales-by-prod-tsm-btn" data-isa-id="' + isaId + '">Sales by Product Line</a>';
        break;

      case 'Sales by Product Line':
        cogHTML += '<a href="#' + isaId + '" class="dropdown-item cb-sales-by-prod-btn" data-isa-id="' + isaId + '">Sales by Product Line</a>';
        break;
