...
// Generate HTML Table
function makeDashboardMetric(
	parentDiv,
	bucketLabels = [],
	boxClass = "dashboard-metrics-content-sm"
) {
	...
	if (
		Array.isArray(recordCount(bucketApp_Keys)) &&
...
function makeDashboardMetricForISATeamGroup(
	parentDiv,
	bucketApp_Keys,
	bucketLabels = [],
	tab
