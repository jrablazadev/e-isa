...
var cogLinks = {
        // TSM
                ...
                , '25D550009b4423d2683543168fc8' : ['Log an A.M.P.', 'Create New Deal', 'View Attachments','ComCept Pricing', 'ComCept AR', 'Deal Termination'] //  Deal Directory
	...
	// RSM
        ...
        // Breach/Termination WQ
                , '25D55000f91c845405554b4f85f7' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'ComCept AR', 'ComCept Pricing'] //  Breach Work Queue
                , '25D550007e78bfffce2140e897e4' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'ComCept AR', 'ComCept Pricing'] //  Breach Work Queue
                , '25D550000e4ea070622a487ebc5e' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'ComCept AR', 'ComCept Pricing'] //  Breach Work Queue
                , '25D550003f9f6daf53f7485298ba' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'ComCept AR', 'ComCept Pricing'] //  Breach Work Queue
                , '25D55000618c4b059e5940538a50' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'ComCept AR', 'ComCept Pricing'] //  Breach Work Queue
                , '25D55000ef0488b6fd5a42668381' : ['View Details', 'Comments', 'View Attachments', 'Related Accounts - View', 'ComCept AR', 'ComCept Pricing'] //  Breach Work Queue
...
// Log an A.M.P.
$(document).on('click', '.cb-log-an-amp', function(e){
        var isaId = $(this).attr('data-isa-id');
        var isaName = $(this).attr('data-isa-name');
        var pid = $(this).attr('data-pid');
        window.open('https://caspio.thenetwork-crm.com/dp/25d55000085a1a0e10d040a4a304?PID=' + pid);
        e.preventDefault();
});
...
function create_cog(elem)
{
        ...
        $.each(cogLinks[appKey], function(i, link){
                ...
                switch(link)
                {
                        ...
                        case 'Log an A.M.P.':
                                cogHTML += '<a href="#' + isaId + '" class="dropdown-item cb-log-an-amp" data-isa-id="' + isaId + '" data-pid="' + pid + '">Log an A.M.P.</a>';
                                break;
                }
        });
