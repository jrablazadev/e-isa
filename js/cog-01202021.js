...
$(document).on("click", ".cb-log-an-amp", function (e) {
	...
	window.open(
		"https://caspio.thenetwork-crm.com/dp/25d55000085a1a0e10d040a4a304?PID=" +
			pid
	);
	e.preventDefault();
});
...
function create_cog(elem) {
	...
	cogHTML +=
		...
		isaId +
		'" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="';
		...
		switch (link) {
			...
			case "Log an A.M.P.":
				cogHTML +=
					'<a href="#' +
					isaId +
					'" class="dropdown-item cb-log-an-amp" data-isa-id="' +
					isaId +
					'" data-pid="' +
					pid +
					'">Log an A.M.P.</a>';
