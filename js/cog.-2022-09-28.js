...
var cogLinks = {
	...
	// RSM
		...
		, '25d55000776c517679d747fdbc51' : ['View Details', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View'] //  Execution Work Queue
                , '25d550007de177a7731b450bbd2e' : ['View Details', 'View Attachments', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Production Line'] //  Deal Directory
        ...
        // ISA Team
                ...
                , '25d5500047bbef748cce468fb668' : ['View Details', 'Edit Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Production Line'] //  Deal Directory 2
        ...
        // KN
                ...
                , '25d55000060418d036fb4620b99d' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Production Line'] //  Deal Directory
        ...
        // CFO
                ...
                , '25d5500062ebac071ec04163bf0a' : ['View Details', 'E-ISA Logs', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View'] //  Execution Phase
                , '25d550004b797fb9e94c4e63a277' : ['View Details', 'Comments', 'Attachments', 'Related Accounts - View', 'Allocate Asset', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay - View', 'Sales by Production Line'] //  Deal Directory
		...
		, '25d550003cba56b852da4645ac6b' : ['View Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Production Line'] // Deal Directory
		, '25d550008604295b600d4e91baa4' : ['View Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Production Line'] // Deal Directory
	...
	// ISA Team DD - Temporary page for formula verification
		, '25d550001c72a60eee144283bcb2' : ['View Details', 'Edit Details', 'Comments', 'Attachments', 'Related Accounts', 'Allocate Asset', 'Create New Deal', 'E-ISA Logs', 'Deal Termination', 'ComCept AR', 'ComCept Pricing', 'Direction To Pay', 'Sales by Production Line'] // Deal Directory
...
function create_cog(elem)
{
        ...
        cogHTML += '<a class="btn btn-link btn-sm dropdown-toggle" href="#' + isaId + '" role="button" data-toggle="dropdown" aria-haspopup="true" data-bs-display="static" aria-expanded="false" title="';
        ...
        $.each(cogLinks[appKey], function(i, link){
			...
			case 'Sales by Production Line - TSM':
                        ...
                        case 'Create New Deal - TSM':
                                cogHTML += '<a href="#' + isaId + '" class="dropdown-item cb-create-new-deal-tsm-btn" data-isa-id="' + isaId + '">Create New Deal</a>';
                                break;
                }
        });
