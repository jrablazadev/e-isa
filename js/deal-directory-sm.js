...
function total_amp_link() {
	$('#cb-deal-directory *[data-cb-name="data"] td:nth-child(7)').each(
		function () {
			...
			$(this).html(
				'<a href="https://caspio.thenetwork-crm.com/dp/25d55000f336c6057fbd4dc5b678?Customer_ID=' +
					customer_id +
					'" target="_blank">' +
					total +
					"</a>"
...
function my_amp_link() {
	$('#cb-deal-directory *[data-cb-name="data"] td:nth-child(8)').each(
		function () {
			...
			$(this).html(
				'<a href="https://caspio.thenetwork-crm.com/dp/25d55000afcb918573cf4edcbf14?Customer_ID=' +
					customer_id +
					'" target="_blank">' +
					total +
					"</a>"
...
function percent_complete_graph() {
	$('#cb-deal-directory *[data-cb-name="data"] td:nth-child(10)').each(
		function () {
...
function open_mpo_detail_report(elem) {
	...
	window.open(
		`https://caspio.thenetwork-crm.com/dp/25d55000d73be61d9bb142c8b3bd?cbResetParam=1&ID=${isa_id}`,
		"_blank"
	);
}
...
function actual_gp_link() {
	$('#cb-deal-directory *[data-cb-name="data"] td:nth-child(19)').each(
		function () {
			...
			var percentage = (Number($(this).html()) * 100).toFixed(
				1
			);
			console.log(percentage);
			var isa_id =
			...
			$(this).html(
				'<a href="https://caspio.thenetwork-crm.com/dp/25d55000f55f7f0f540c43efa447?ISA_ID=' +
					isa_id +
					'" target="_blank">' +
					percentage +
					"%</a>"
