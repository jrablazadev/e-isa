...
$(document).on(
  "focus",
  '*[action*="b96a9d3e109a412da10b"] *[name$="Log1c_Cx_Disc"]',
  function () {
    callMasking(this);
  }
);
...
$(document).on(
  "focus",
  '*[action*="b96a9d3e109a412da10b"] *[name$="Color_Software_Discount"]',
  function () {
    callMasking(this);
  }
);
...
const isa_details_init = () => {
  ...
  if ($('form[action*="b96a9d3e109a412da10b"]')) {
    report_init("b96a9d3e109a412da10b");
  }
  if ($('form[action*="2e75a1e2338d4a1cbf91"]')) {
