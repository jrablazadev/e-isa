...
<body class="hide">
    ...
    <main role="main" class="container mb-5 mt-5">
		...
		<div class="mb-5">
			<a href="javascript:void(0)" onclick="window.history.back();" class="mb-5">Back</a>
		</div>
		...
		<div id="section10-1" class="mb-5">
			...
			<div class="mb-3">
				<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d550009bc1d07cd64e4db5af1f/emb"></script>
			</div>
		...
		<div id="section10-2" class="expandheader mb-5 cb-acct-related">
			<h3>Account Related</h3>
			<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d5500015abafea6332463196f6/emb"></script>
		</div>
		...
		<div class="mb-5">
			<h3>Comments</h3>
			<script type="text/javascript" src="https://caspio.thenetwork-crm.com/dp/25d550006448102cf93f4f7ebf39/emb"></script>
		</div>
		...
		<script>
			document.addEventListener('DataPageReady', function (event) {
				...
				// MPO Pane 
				if ((event.detail.appKey).includes("ebc230c74a9182dc")) {
					setTimeout(function () {
						show_MPO_Details()
					}, 1000)
				}
			...
			{
				var search_fields = setInterval(function () {
					if ($('*[name="EditRecordPaint_Manufacturer"]').length) {
						clearInterval(search_fields)
						...
						{
							$('#MPO_Details_Iframe2').removeAttr('src');
							return false;
						}

						$('#MPO_Details_Iframe2').attr({ 'src' : '../view-details-mpo.php' + URL_Param });
						var count_calling_iframe_autoresize = 0
						setInterval(function () {
							if (count_calling_iframe_autoresize <= 5) {
								iframe_autoresize($('#MPO_Details_Iframe2'))
								count_calling_iframe_autoresize++
								console.log({count_calling_iframe_autoresize})
							}
						}, 1000)
					}
				}, 1000)
