...
<body class="hide">
	...
	<main role="main" class="container mb-5 mt-5">
		...
		<?php if (isset($_GET['Recompute'])): ?>
			...
			<div id="section10-2" class="expandheader mb-5 cb-acct-related">
				...
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>15abafea6332463196f6/emb"></script>
			</div>
			...
			<div class="mb-3">
				<h4 class="step-6-container">
					...
					<a href="./direction-to-pay.php?ISA_ID=<?php echo isset($_GET['ISA_ID']) ? $_GET['ISA_ID'] : 0; ?>" class="d2p-anchor" target="_blank">Here</a>
				</h4>
			</div>
			...
			<div id="section12-2" class="expandheader mb-5">
				...
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>5a8f53f5d65d4ba38403/emb"></script>
			</div>

			<hr>
			<div id="section12-3" class="expandheader mb-5">
				<h3>Estimated Returns - Allied Returns</h3>
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>047b870777eb439b9df5/emb"></script>
			</div>

			<hr>
			<div id="section12-4" class="expandheader mb-5">
				<h3>Estimated Returns - Total Returns</h3>
				<script type="text/javascript" src="<?= $cb_datapage_prefix ?>5491fe366eba4baba99e/emb"></script>
			</div>
	...
	<script src="../js/investments-coo-view.js"></script>
