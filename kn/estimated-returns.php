		...
		<script>
			...
			document.addEventListener('DataPageReady', function (event) {
				if((event.detail.appKey).search('d413cf8b55054b9bbe8b') >= 0 || (event.detail.appKey).search('84a9b761673a46f3ab9f') >= 0)
				{
					...
					$('.dealtotal[data-investmentid="51"]').eq(0).addClass('btn-link').css({ 'cursor' : 'pointer' });
					$('.dealtotal[data-investmentid="51"]').eq(0).attr('onclick', "openModal_v2('Finalize Commission Rate', 'https://caspio.thenetwork-crm.com/dp/25d550009b07e447762f442b9133/emb?ISA_ID=" + ISAId + "')");
				}
			});
