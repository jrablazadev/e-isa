...
<head>
	...
	<link rel="stylesheet" href="../css/common.css?v=<?php echo date('YmdHis'); ?>" media="screen" title="no title" charset="utf-8">
	<link href="https://fonts.googleapis.com/css?family=Lato" rel="stylesheet">

	<title>E-ISA | Contract Phase Link</title>
	<style>
		.headers {
...
<body class="hide">
	...
	<script>
		...
		document.addEventListener('DataPageReady', function(event) {
			...
			$(".equip-1 .cbResultSetTableCell").css("font-size", "8px")
			$(".equip-1 .cbResultSetLabel").css("font-size", "8px")

			$(".discount-1 .cbResultSetTableCell").css("font-size", "8px")
			$(".discount-1 td.cbResultSetData").css("font-size", "8px")
			$(".discount-1 th.cbResultSetLabel a").css("font-size", "8px")
			$(".cbResultSetTotalsLabel").css("font-size", "8px")
			$(".cbResultSetTotalsData").css("font-size", "8px")

			$(".discount-2 .cbResultSetTableCell").css("font-size", "8px")
			$(".discount-2 td.cbResultSetData").css("font-size", "8px")
			$(".discount-2 th.cbResultSetLabel").css("font-size", "8px")
			$(".cbResultSetTotalsLabel").css("font-size", "8px")
			$(".cbResultSetTotalsData").css("font-size", "8px")

			$(".discount-3 .cbResultSetTableCell").css("font-size", "8px")
			$(".discount-3 td.cbResultSetData").css("font-size", "8px")
			$(".discount-3 th.cbResultSetLabel").css("font-size", "8px")
			$(".cbResultSetTotalsLabel").css("font-size", "8px")
			$(".cbResultSetTotalsData").css("font-size", "8px")


			$(".contract-1 .cbFormLabelCell").css("font-size", "8px")
			$(".contract-1 .cbFormDataCell").css("font-size", "8px")
			$(".contract-1 .cbFormCalculatedField").css("font-size", "8px")
			$(".contract-1 .cbFormData").css("font-size", "8px")


			$(".cb-manufacturers .cbResultSetLabel").css("font-size", "8px")
			$(".cb-manufacturers .cbResultSetData").css("font-size", "8px")
		...
		function removeZeros() {
			...
			for (var i = 0; i < equip_table_tr.length - 1; i++) {
				var equip_table_tr_value = $(".equip-1 table tr").eq(i).find(".dealtotal").attr("data-value")
				if (equip_table_tr_value == "0" || equip_table_tr_value == "") {
					// Checker
					// $(".equip-1 table tr").eq(i).css("background", "red")
	...
	<script src="./js/contract-phase-link.js?v=<?php echo date('YmdHis'); ?>"></script>
